if(NOT PORT MATCHES "(boost|hwloc|libpq|icu|harfbuzz|^qt[a-z]+|benchmark|gtest|pkgconf)")
    set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "x64-windows-llvm.toolchain.cmake")
...
elseif(PORT MATCHES "(nothing)")
    if(EXISTS "${POSSIBLE_LLVM_BIN_DIR}")
        set(ENV{PATH} "$ENV{PATH};${POSSIBLE_LLVM_BIN_DIR}")
    endif()
    set(VCPKG_QT_TARGET_MKSPEC win32-msvc)
    set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "x64-windows-llvm.toolchain.cl.cmake")
elseif(PORT MATCHES "(benchmark|gtest|pkgconf|^qt[a-z]+)")
    ...
    set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "x64-windows-llvm.toolchain-no-lto.cmake")
    if(DEFINED VCPKG_PLATFORM_TOOLSET)
        set(VCPKG_PLATFORM_TOOLSET ClangCL)
    endif()
    if(EXISTS "${POSSIBLE_LLVM_BIN_DIR}")
