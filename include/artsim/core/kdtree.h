//
// Created by lasagnaphil on 21. 2. 19..
//

#ifndef ARTSIM_KDTREE_H
#define ARTSIM_KDTREE_H
...
using kdtree_vec2 = kdtree<2, float>;
using kdtree_vec3 = kdtree<3, float>;
using kdtree_vec4 = kdtree<4, float>;

#endif //ARTSIM_KDTREE_H
